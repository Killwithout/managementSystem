...
<div class="header bg-main">
  ...
  <div class="head-l"><a class="button button-little bg-green" href="" target="_blank"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;<a href="#" class="button button-little bg-blue"><span class="icon-wrench"></span> 清除缓存</a> &nbsp;&nbsp;<a class="button button-little bg-red" href="../page/loginValidate"><span class="icon-power-off"></span> 退出登录</a> </div>
  <!-- 欢迎 *** 登录 -->
  <div class="head-p">
  	  欢迎 * <%=request.getSession().getAttribute("names") %>  * 登录后台管理系统
  </div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="onePage" target="right"><span class="icon-caret-right"></span>单页管理</a></li>  
